...
<header id="header" class="transparent-header" data-sticky-class="not-dark">
			<div id="header-wrap">
				<div class="container clearfix">
					...
					<div id="logo">
						<a href="index.php" class="standard-logo" data-dark-logo="CELTimages\celtlogo_standard.png"><img src="CELTimages\celtlogo_standard.png" alt="CELT Logo"></a>
						<a href="index.php" class="retina-logo" data-dark-logo="CELTimages\celtlogo_retina.png"><img src="CELTimages\celtlogo_retina.png" alt="CELT Logo"></a>
					</div>					
					<nav id="primary-menu" class="dark">
						<ul>
						<li><a class="wow zoomIn" data-wow-delay=".2s" href="index.php"><div>Home</div></a></li>
						<li><a class="wow zoomIn" data-wow-delay=".2s" target="_blank" href="kiitecell.php"><div >KIIT E-Cell</div></a>
							<ul>	
					    	<li><a class="wow zoomIn" data-wow-delay=".2s" target="_blank"  href="http://celtindia.org/kiitecell.php#ecell"><div>E-Cell</div></a>
					    	<li><a class="wow zoomIn" data-wow-delay=".2s"  target="_blank" href="http://ecell.org.in/mentors.php"><div>Advisors</div></a>
					    	<li><a class="wow zoomIn" data-wow-delay=".2s"  target="_blank" href="kiitecell.php#prog"><div>Our Initiatives</div></a>
					    	<li><a class="wow zoomIn" data-wow-delay=".2s" target="_blank"  href="http://ecell.org.in"><div>Website</div></a>
					    	<li><a class="wow zoomIn" data-wow-delay=".2s" target="_blank"  href="http://blog.ecell.org.in/"><div>Blog</div></a>
					    </ul>
						</li>
					    ...
					    <ul>	
					    	...
					    	<li><a class="wow zoomIn" data-wow-delay=".2s" href="conference.php#key"><div>Speakers</div></a>
					    </ul>
					    </li>
					    <li><a class="wow zoomIn" data-wow-delay=".2s" href="#"><div>Apply</div></a>
					    	<ul>	
					    	<li><a class="wow zoomIn" data-wow-delay=".2s" href="http://celtindia.org/dashboard/login.html"><div>Delegate Registrations</div></a>
					    	<li><a class="wow zoomIn" data-wow-delay=".2s" href="https://celtindia.org/leader.php"><div>Contingent Registration</div></a>
					    	</ul>
					 	</li>
