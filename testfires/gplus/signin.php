 ...
 */
const CLIENT_ID = '76558560917-j21071ji1u0ssfvs10rrnemo6a43osj3.apps.googleusercontent.com';

/**
 * Replace this with the client secret you got from the Google APIs console.
 */
const CLIENT_SECRET = '-WKniSypWeV2xRPa89kWxH62';

/**
 * Optionally replace this with your application's name.
 */
const APPLICATION_NAME = "CELT Login";
