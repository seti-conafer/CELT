...
<header id="header" class="transparent-header" data-sticky-class="not-dark">
			<div id="header-wrap">
				<div class="container clearfix">
					...
					<div id="logo">
						<a href="index.php" class="standard-logo" data-dark-logo="https://celtindia.org/CELTimages/celtindia-web2.png"><img src="CELTimages\celtindia-web2.png" alt="CELT Logo"></a>
						<a href="index.php" class="retina-logo" data-dark-logo="CELTimages\celtindia-web1.png"><img src="https://celtindia.org/CELTimages/celtindia-web1.png" alt="CELT Logo"></a>
					</div>					
					<nav id="primary-menu" class="dark">
						...
						<li><a class="wow zoomIn" data-wow-delay=".2s"  href="http://celtwrites.blogspot.in" target="_blank"><div>Blog</div></a></li>
						</ul>
					</nav>
				</div>
			</div>
