...
$result=$conn->query('SET @user:= $userid ;SELECT cpay, cdel, csch, camb , payment_image_url from registration,profile WHERE registration.id = @user AND profile.userid = @user');
