	...
	<div id="wrapper" class="clearfix">
      <?php require_once 'navbar.php'; ?>
		...
		<div class="swiper-container swiper-parent">
			...
			<div class="swiper-slide dark">
						<div class="container clearfix">
							...
							<div  style=" margin-left:-200px; margin-top: 150px; float:left; position:relative; !important;">
								<p id="papa">		
								...
								<p><a href="dashboard/login.html" class="wow bounceInRight button button-reg" data-wow-delay="2s" style="margin-right:4000px;">Register & Login</a></p>
							
							</div>
							</div>
						</div>
						<div class="video-wrap" style="width:105%;">
							<img src="cover.jpg" id="slide-video" style="width:100%; height:100%" ">
							<!-- <video id="slide-video" poster="images/videos/Celt.mp4" preload="auto" loop autoplay muted>
								<source src="images/videos/Celt.mp4" type='video/mp4' />
							</video> -->
			...
			<a class="dark one-page-arrow"><i class="icon-angle-down infinite animated fadeInDown"></i></a>
		...
		<section id="slider" class="slider-parallax swiper_wrapper full-screen clearfix">
			...
			<div class="swiper-container swiper-parent">
				<div class="swiper-wrapper">
					<div class="swiper-slide dark" style="background-image: url('yh.jpg');">
						<div class="container clearfix">
							<div class="slider-caption slider-caption-center">
					...
					<div class="swiper-slide dark" style="background-image: url('images/slider/swiper/s1.jpg');">
						<div class="container clearfix">
							<div class="slider-caption slider-caption-center">
								<!--h2 data-caption-animate="fadeInUp">Welcome to CELT</h2>
								<p data-caption-animate="fadeInUp" data-caption-delay="200">Create just what you need for your Perfect Website. Choose from a wide range of Elements &amp; simply put them on your own CELT.</p-->
					...
					<div class="swiper-slide" style="background-image: url('images/slider/swiper/s2.jpg'); background-position: center top;">
						<div class="container clearfix">
				...
				<div class="swiper-slide" style="background-image: url('images/slider/swiper/s3.jpg'); background-position: center top;">
						<div class="container clearfix">
							<div class="slider-caption">
								<!--h2 data-caption-animate="fadeInUp">Great Performance</h2>
								<p data-caption-animate="fadeInUp" data-caption-delay="200">You'll be surprised to see the Final Results of your Creation &amp; would crave for more.</p-->
				...
				<div class="swiper-slide" style="background-image: url('images/slider/swiper/s4.jpg'); background-position: center top;">
						<div class="container clearfix">
							<div class="slider-caption">
								<!--h2 data-caption-animate="fadeInUp">Great Performance</h2>
								<p data-caption-animate="fadeInUp" data-caption-delay="200">You'll be surprised to see the Final Results of your Creation &amp; would crave for more.</p-->
				...
				<div class="swiper-slide" style="background-image: url('images/slider/swiper/s5.jpg'); background-position: center top;">
						<div class="container clearfix">
							<div class="slider-caption">
								<!--h2 data-caption-animate="fadeInUp">Great Performance</h2>
								<p data-caption-animate="fadeInUp" data-caption-delay="200">You'll be surprised to see the Final Results of your Creation &amp; would crave for more.</p-->
				...
				<div class="swiper-slide" style="background-image: url('images/slider/swiper/s6.jpg'); background-position: center top;">
						<div class="container clearfix">
							<div class="slider-caption">
								<!--h2 data-caption-animate="fadeInUp">Great Performance</h2>
								<p data-caption-animate="fadeInUp" data-caption-delay="200">You'll be surprised to see the Final Results of your Creation &amp; would crave for more.</p-->
				...
				<div class="swiper-slide" style="background-image: url('images/slider/swiper/s7.jpg'); background-position: center top;">
						<div class="container clearfix">
							<div class="slider-caption">
								<!--h2 data-caption-animate="fadeInUp">Great Performance</h2>
								<p data-caption-animate="fadeInUp" data-caption-delay="200">You'll be surprised to see the Final Results of your Creation &amp; would crave for more.</p-->
				...
				<div class="swiper-slide" style="background-image: url('images/slider/swiper/s8.jpg'); background-position: center top;">
						<div class="container clearfix">
							<div class="slider-caption">
								<!--h2 data-caption-animate="fadeInUp">Great Performance</h2>
								<p data-caption-animate="fadeInUp" data-caption-delay="200">You'll be surprised to see the Final Results of your Creation &amp; would crave for more.</p-->
				...
				<div class="swiper-slide" style="background-image: url('images/slider/swiper/s9.jpg'); background-position: center top;">
						<div class="container clearfix">
							<div class="slider-caption">
								<!--h2 data-caption-animate="fadeInUp">Great Performance</h2>
								<p data-caption-animate="fadeInUp" data-caption-delay="200">You'll be surprised to see the Final Results of your Creation &amp; would crave for more.</p-->
					...
					<div class="swiper-slide" style="background-image: url('images/slider/swiper/s10.jpg'); background-position: center top;">
						<div class="container clearfix">
							<div class="slider-caption">
								<!--h2 data-caption-animate="fadeInUp">Great Performance</h2>
								<p data-caption-animate="fadeInUp" data-caption-delay="200">You'll be surprised to see the Final Results of your Creation &amp; would crave for more.</p-->
					...
					<div class="swiper-slide" style="background-image: url('images/slider/swiper/s11.jpg'); background-position: center top;">
						<div class="container clearfix">
							<div class="slider-caption">
								<!--h2 data-caption-animate="fadeInUp">Great Performance</h2>
								<p data-caption-animate="fadeInUp" data-caption-delay="200">You'll be surprised to see the Final Results of your Creation &amp; would crave for more.</p-->
					...
					<div style="font-family: Goudy Old Style;" class="postcontent nobottommargin clearfix">
						...
						<table class="table">
						  ...
						  <tr style=" border:0px;">
							...
							<tr>
							  <td style=" border:0px; font-size:20px;">July 20 ,2016</td>
