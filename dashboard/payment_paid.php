...
else if($university!='KIIT' && $university!='K.I.I.T' && $university!='k.i.i.t' && $university!='KIIT University' &&  $university!='kiit university' && $university!='kalinga institute industrial technology' && $university!='Kalinga Institute Industrial Technology' && $university!='kiit' && $university!='KiiT')
{
									...
									<div class="entry-title">
										<h5 style="font-size: 1.3rem; color:black !important; text-decoration:none; ">
											<span class="materialize-textarea">
												Your application has been selected and the payment has been completed successfully. Hope to see you at CELT 2016, India.
											</span>
										</h5>
									</div>				
								</div>
