			...
			<div class="swiper-container swiper-parent">
				<div class="swiper-wrapper">
					<div class="swiper-slide dark" style="background-image: url('cover1.jpg');">
						...
						<div class="swiper-slide" style="background-image: url('cover10.jpg'); background-position: center top;"></div>
						<div class="swiper-slide" style="background-image: url('naralokesh.png'); background-position: center top;"></div>						
